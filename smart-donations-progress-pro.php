...
<p>The progress indicators are a pro feature, you can learn more and unlock them here:</p>
<a target="_blank" style="display: block; font-size: 20px; font-weight: bold; margin-top:5px;margin-bottom:10px;" href="http://rednao.com/smartdonations.html">Learn More (Video Tutorials)</a>
</div>
...
<a target="_blank" href="<?php echo DEVOARCES_URL?>smartdonations.html"> <img id="smartDonationsImageClassic" src="<?php echo plugin_dir_url(__FILE__)?>images/addNewProgressPro.png" alt="" width="760" height="760"></a>
