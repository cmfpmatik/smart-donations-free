...
<a target="_blank" href="<?php echo DEVOARCES_URL?>smartdonations.html"> <img id="smartDonationsImageClassic" src="<?php echo plugin_dir_url(__FILE__)?>images/analitics-pro.png" alt="" width="760" height="760"></a>
