...
register_activation_hook(__FILE__,'rednao_SMARTFREE_DONATIONS_plugin_was_activated');
add_action('admin_init','rednao_SMARTFREE_DONATIONS_plugin_was_activated');
add_shortcode('sdonations','rednao_SMARTFREE_DONATIONS_short_code');
add_shortcode('sdprogress','rednao_SMARTFREE_DONATIONS_progress_short_code');
add_shortcode('sddonwall','rednao_SMARTFREE_DONATIONS_wall_short_code');

add_action('init', 'rednao_SMARTFREE_DONATIONS_init');
add_action('admin_menu','rednao_SMARTFREE_DONATIONS_create_menu');
...
function rednao_SMARTFREE_DONATIONS_create_menu(){
    wp_enqueue_script('jquery');
    wp_enqueue_script('jquery-ui-core');
    wp_enqueue_script('query-ui-dialog');
    add_menu_page('Smart  Free Donations','Smart Free Donations',SMARTFREE_DONATIONS_REQUIRED_ROLE,'SMARTFREE_DONATIONS_menu','rednao_smartdonations_donation_buttons',plugin_dir_url(__FILE__).'images/smartDonationsIcon.png');
...
function rednao_SMARTFREE_DONATIONS_plugin_was_activated()
{
    $dbversion=get_option("REDNAO_SMARTFREE_DONATIONS_DB_VERSION");
    ...
    if(!$dbversion|| $dbversion<SMARTFREE_DONATIONS_LATEST_DB_VERSION )
    {
        ...
        update_option("REDNAO_SMARTFREE_DONATIONS_DB_VERSION",SMARTFREE_DONATIONS_LATEST_DB_VERSION);
    }
}
...
{
    include(SMARTFREE_DONATIONS_DIR.'/smartdonations-settings.php');
}
